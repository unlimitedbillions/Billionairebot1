...
try:
    ...
    logger.info("Importing speech.config...")
    from speech import config
    logger.info("Importing speech.database...")
    from speech import database
    logger.info("Importing speech.main (this may take a while due to torch/transformers)...")
